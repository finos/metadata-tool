...
<body>
  <h3>${program.program_name} PMC Report for March ${now}</h3>
  ...
  <p>Certain privileges (such as voting rights) are reserved to “active participants” in a project or working group, as defined by the FINOS <a href="https://drive.google.com/a/finos.org/open?id=1E7U4nPwnzAo6CwFwCWbkItL6wzR68LbGgl5dIkiLBCM">Active Participation Policy.</a> A list of Active participants can be found on your <a href="https://metrics.finos.org/app/kibana?#/dashboard/0e542930-4f2d-11e9-9e7c-eb1eab055f1f?_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-6m,mode:quick,to:now))&_a=(filters:!(),query:(query_string:(analyze_wildcard:!t,query:'cm_program:%22${program.program_short_name}%22')))">Program Health dashboard.</a></p>
